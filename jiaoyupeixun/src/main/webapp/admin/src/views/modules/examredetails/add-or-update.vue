    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="examquestionId" name="examquestionId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学生答案" prop="examredetailsMyanswer">
                       <el-input v-model="ruleForm.examredetailsMyanswer"
                                 placeholder="学生答案" clearable  :readonly="ro.examredetailsMyanswer"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学生答案" prop="examredetailsMyanswer">
                           <el-input v-model="ruleForm.examredetailsMyanswer"
                                     placeholder="学生答案" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   examredetailsMyanswer: [
                              { required: true, message: '学生答案不能为空', trigger: 'blur' },
                          ],
                   examredetailsMyscore: [
